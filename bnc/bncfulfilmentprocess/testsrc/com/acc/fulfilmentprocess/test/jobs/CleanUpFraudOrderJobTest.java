 ...
 *  
 */
package com.acc.fulfilmentprocess.test.jobs;
...
import com.acc.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = BncFulfilmentProcessConstants.ORDER_PROCESS_NAME;
