 ...
 *  
 */
package com.acc.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(BncFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BncFulfilmentProcessConstants.PARENT_PROCESS);
