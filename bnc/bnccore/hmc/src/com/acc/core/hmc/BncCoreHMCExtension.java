...
/**
 * Provides necessary meta information about the bnccore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class BncCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(BncCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.acc.core.hmc.locales";
