...
if(e.which==13){
e.preventDefault();
var idx=$("form input, form textarea").index(this);
$("form input, form textarea").eq(idx+1).focus();
return false;
}
});
});
...
$.event.add(window,"resize",resizeTimeline);
var w;
function resizeTimeline(){
if($("#timeline").length!=0&&$("#about_rhs").length!=0&&$(window).width()>767){
$('#timeline').height("auto");
var wwd_h=$('#timeline').outerHeight();
var rhs_h=$('#about_rhs').outerHeight();
if(wwd_h<rhs_h){
$('#timeline').height(rhs_h);
}
}else{
$('#timeline').height("auto");
}
...
if($("#view_bar.fixed").length==0){
if($(window).width()>767){
var offset=$(window).scrollTop();
var intro_h=$(".page_intro").outerHeight();
var bar_h=$("#view_bar").outerHeight();
var nav_h=$("#head").height();
if(offset>=intro_h){
$("#view_bar").css({"position":"fixed","top":nav_h+"px"});
$(".page_content").css({"margin-top":bar_h+"px"});
}else{
$("#view_bar").css({"position":"relative","top":"auto"});
...
/*
$('p#menu_top a').toggle(function(){
	$("#head nav").slideDown();
},function(){
	$("#head nav").slideUp(function(){
	$("#head nav").css({"display":""});
});*/
//$('p#menu_top a').
...
var h=$i.height();
if(!h){
var $parents=$i.parents().filter(function(){
...
var t=Math.round(($c.innerHeight()/2)-(h/2));
...
var myLatLng=new google.maps.LatLng(51.384337,-2.363206);
var mapOptions={
center:myLatLng,
scrollwheel:false,
...
boxText.innerHTML="<ul id='overlay_contact_details'><li class='phone'>01225 314646</li><li class='email'><a href='mailto:hello@floatdesign.net'>hello@floatdesign.net</a></li><li class='address'>39 Gay St, Bath BA1 2NT</li></ul>";
var myOptions={
content:boxText
...
,zIndex:null
,boxStyle:{
background:"url('/bnc_images/map-overlay-bg.png') left center no-repeat"
,width:"320px"
,height:"160px"
}
,closeBoxURL:""
...
$("#blog_content article a,#home_boxes article.blog a").bind("mouseover",function(){
$(this).closest("article").find("a").addClass("hover");
}).bind("mouseout",function(){
$(this).closest("article").find("a").removeClass("hover");
});
$("#home_boxes").alignMiddle("article","span");
$("#case_work ul").alignMiddle("li","strong");
$("section#home_intro article").alignMiddle("div");
});
