...
import com.acc.test.constants.BncTestConstants;
import com.acc.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = BncTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/bnctest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/bnctest/import/reviews.impex");
			...
			importImpexFile(context, "/bnctest/import/cstickets.impex");
		}
	}
}
