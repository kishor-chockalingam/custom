 ...
 *  
 */
package com.acc.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("bnccockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("bnccockpits.product.externalTaxes"));
