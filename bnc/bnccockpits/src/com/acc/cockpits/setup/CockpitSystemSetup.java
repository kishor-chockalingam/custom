 ...
 *  
 */
package com.acc.cockpits.setup;
...
import com.acc.cockpits.constants.BncCockpitsConstants;
 ...
 */
@SystemSetup(extension = BncCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(BncCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(BncCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						BncCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/bnccockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
