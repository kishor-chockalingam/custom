...
import com.acc.constants.BncwebserviceshmcConstants;



/**
 * This is the extension manager of the Bncwebserviceshmc extension.
 */
public class BncwebserviceshmcManager extends GeneratedBncwebserviceshmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BncwebserviceshmcManager.class.getName());
	 ...
	 */
	public static BncwebserviceshmcManager getInstance()
	{
		return (BncwebserviceshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BncwebserviceshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BncwebserviceshmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BncwebserviceshmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BncwebserviceshmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BncwebserviceshmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
