 ...
 *  
 */
package com.acc.expressupdate.channel;
...
import com.acc.expressupdate.util.ProductExpressUpdateElementPredicate;
...
public class ProductExpressUpdateChannelListener
{
	...
	private ExpressUpdateQueue<ProductExpressUpdateElementData> productExpressUpdateQueue;
	...
	public ExpressUpdateQueue<ProductExpressUpdateElementData> getProductExpressUpdateQueue()
	{
		return productExpressUpdateQueue;
	}

	@Required
	public void setProductExpressUpdateQueue(final ExpressUpdateQueue<ProductExpressUpdateElementData> productExpressUpdateQueue)
	{
